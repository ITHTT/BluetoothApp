 ...
 */
public class RandomViewLayout extends FrameLayout implements ViewTreeObserver.OnGlobalLayoutListener{
    private static final String tag = RandomViewLayout.class.getSimpleName();
    ...
    public RandomViewLayout(Context context) {
        super(context);
        init(null,context);
    }

    public RandomViewLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs,context);
    }

    public RandomViewLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs,context);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public RandomViewLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
